/*
  ...
  - Added the required column `userId` to the `TransactionsMoney` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_TransactionsMoney" ("categoryId", "created_at", "id", "price", "title", "updated_at") SELECT "categoryId", "created_at", "id", "price", "title", "updated_at" FROM "TransactionsMoney";
